    ...
    if age is not None:
        ...
        if age <= 0 and age >= 65:
            return build_validation_result(
                False, 
                "age",
                "Your age should be greater than 0 and less than 65 years old for this Investment Recommendation.",
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False, 
                "investment_amount",
                "Your investment amount should be equal to or greater than 5000 dollars.",
            )
...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        validated_data = validate_data(age, investment_amount, intent_request)

        if not validated_data["isValid"]:
            slots[validated_data["violatedSlot"]] = None 

            return elicit_slot(
                intent_request["sessionAttributes"],
                intent_request["currentIntent"]["name"],
                slots,
                validated_data["violatedSlot"],
    ...
    return close(
        ...
        "Fulfilled", 
        {
            ...
            "content":"""None: 100 percent bonds (AGG), 0 percent equities (SPY)
